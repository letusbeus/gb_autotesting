...
if __name__ == '__main__':
    def test_function(command: str, search_text: str, split_words: bool = False) -> bool:
        """
        ...
        :return: True if he command executed successfully and the text is found in its output, otherwise False.
        """
    ...
    print(test_function('cat /etc/os-release', 'Minotaur', True))
